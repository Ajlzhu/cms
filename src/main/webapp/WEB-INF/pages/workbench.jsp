...
<div class="weadmin-body">
    <blockquote class="layui-elem-quote">欢迎使用CMS后台管理系统！</blockquote>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <div class="layui-carousel weadmin-notice" lay-filter="notice" lay-indicator="inside" lay-arrow="none" style="width: 100%; height: 280px;">
                            <div carousel-item="">
                                <div class="">
                                    <a href="https://fly.layui.com/case/2018/top/" target="_blank" class="layui-bg-red">2018年3月28日 WeAdmin小版本更新</a>
                                </div>
                                <div class="">
                                    <a href="https://lovetime.gitee.io/weadmin/" target="_blank" class="layui-bg-blue">首款 layui 官方后台模板系统正式发布</a>
                                </div>
                                <div class="">
                                    <a href="https://www.csdn.net/" target="_blank" class="layui-bg-green">Layui 官方发布 layuiAdmin iframe 多标签页版本</a>
                                </div>
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <ul>
                                基于echarts 4.0版本实现中国地图指定省份使用不同颜色标识，指定省份显示气泡图标，
                                    <a href="javascript:;">#详见左侧导航-【系统统计】-【地图DIY实例】</a>
                            </ul>
                        </div>
                    </li>
                    <li class="layui-timeline-item">
